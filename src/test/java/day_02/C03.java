...
public class C03 extends TestBase {
    ...
    public void test01() {
        ...
        for (int i = 0; i < resimler.size(); i++) {
            ...
            resimler.get(i).click(); //i inci index den baslayarak resimlere tiklayacak
            System.out.println(driver.getTitle()); //i den baslayarak resimlerin title larini yazdir
